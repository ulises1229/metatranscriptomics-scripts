...
#SBATCH --job-name="s3-inf-merged"

# cmsearch infernal output 
srun parallel -j 1 'cmsearch --cpu 32 -o {1.}.log --tblout {1.}.infernalout --anytrunc --rfam -E 0.001 rfam/Rfam.cm {1}' ::: *merged*bwa_blat.fasta